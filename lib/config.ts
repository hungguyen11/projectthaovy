...
export const SITE = {
  name: "Wishlist của Thảo Vy",
  brand: "Wishlist của Thảo Vy",
  title: "Wishlist của Thảo Vy — Lưu những món đồ bạn muốn mua",
...
/**
 * Màu trạng thái (độc lập với chủ đề accent — giữ bản sắc nhận diện từng trạng thái).
 */
...
export const MARKETPLACE_META: Record<Marketplace, { label: string; badge: string; letter: string }> = {
  ...
  OTHER: { label: "Web khác", badge: "bg-aqua-soft text-teal-ink dark:bg-teal-950 dark:text-teal-200", letter: "↗" },
};
